...
Project references have been available since TypeScript 3.0. According to the official TypeScript [documentation](https://www.typescriptlang.org/docs/handbook/project-references.html):
