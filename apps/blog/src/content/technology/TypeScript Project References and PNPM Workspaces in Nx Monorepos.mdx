...
Open http://localhost:3000 in your browser to check if the component renders correctly. If everything looks good, let's build our application:
...
That's it. We're now ready to use TypeScript Project References with PNPM Workspace in our Nx monorepo. 🚀
