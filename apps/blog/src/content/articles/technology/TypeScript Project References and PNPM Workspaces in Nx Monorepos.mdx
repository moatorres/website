...
This is not an introduction to [TypeScript Project References](https://www.typescriptlang.org/docs/handbook/project-references.html), nor does it aim to explain [everything you need to know about them](https://nx.dev/articles/typescript-project-references). For more information, the [Nx Blog](https://nx.dev/blog) and the official [TypeScript documentation](https://www.typescriptlang.org/) are great resources.
...
![VSCode Nx TS Workspace](/images/articles/nx-prefs-001.png)
